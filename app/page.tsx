...
import { Play, Code2, Users, Search, Map, Rocket, Trophy, Medal, Crown, LogOut } from 'lucide-react';
...
export default function Dashboard() {
  ...
  const { user, signInWithGoogle, logout, xp, level, loading } = useAuth();
    ...
    return (
      <div className="min-h-screen bg-black flex flex-col items-center justify-center p-6 text-white relative overflow-hidden">
        ...
        <motion.div initial={{opacity:0, scale:0.95}} animate={{opacity:1, scale:1}} className="glass-gold p-12 rounded-3xl max-w-md w-full text-center border border-gold-500/20">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-gold-400 to-gold-600 flex items-center justify-center text-black font-bold text-4xl mx-auto mb-6 shadow-[0_0_30px_rgba(245,158,11,0.2)]">D</div>
